...
const historicalHtmlRoutes: readonly HistoricalHtmlRoute[] = [
  ...
  {
    source: "/cs/pruvodce/jak-poznat-ze-aplikace-opravdu-potrebuje-rewrite/-2/",
    target: "/cs/pruvodce/jak-poznat-ze-aplikace-opravdu-potrebuje-rewrite/",
    category: "legacy",
    reason: "Resolve a reported GSC malformed nested-suffix 404 to the existing guide.",
  },
  {
    source: "/en/templates/checklist-for-migrating-from-spreadsheets-to-an-internal-tool-2/",
    target: "/en/templates/checklist-for-migrating-from-spreadsheets-to-an-internal-tool/",
    category: "legacy",
    reason: "Resolve a reported GSC duplicate-suffix 404 to the existing template.",
  },
  {
    ...
    target: "/en/templates/checklist-for-migrating-from-spreadsheets-to-an-internal-tool/",
    category: "legacy",
    reason: "Resolve a reported GSC malformed nested-suffix 404 to the existing template.",
  },
  {
    source: "/cs/problemy/potrebujeme-prevzit-rozpracovanou-aplikaci/-2/",
    target: "/cs/problemy/potrebujeme-prevzit-rozpracovanou-aplikaci/",
    category: "legacy",
    reason: "Resolve a reported GSC malformed nested-suffix 404 to the existing problem page.",
  },
  {
    source: "/cs/sluzby/vyvoj-webovych-aplikaci-na-miru-2/",
    target: "/cs/sluzby/vyvoj-webovych-aplikaci-na-miru/",
    category: "legacy",
    reason: "Resolve a reported GSC duplicate-suffix 404 to the existing service page.",
  },
  {
    source: "/en/comparisons/custom-web-app-vs-saas-tool-2/",
    target: "/en/comparisons/custom-web-app-vs-saas-tool/",
    category: "legacy",
    reason: "Resolve a reported GSC duplicate-suffix 404 to the existing comparison.",
  },
  {
    source: "/cs/pruvodce/kdy-se-vyplati-automatizace-procesu/-2/",
    target: "/cs/pruvodce/kdy-se-vyplati-automatizace-procesu/",
    category: "legacy",
    reason: "Resolve a reported GSC malformed nested-suffix 404 to the existing guide.",
  },
  {
    source: "/en/comparisons/-1/",
    target: "/en/comparisons/",
    category: "legacy",
    reason: "Resolve a reported GSC malformed hub suffix 404 to the canonical comparisons hub.",
  },
  {
    source: "/cs/srovnani/interni-system-vs-excel-a-email-2/",
    target: "/cs/srovnani/interni-system-vs-excel-a-email/",
    category: "legacy",
    reason: "Resolve a reported GSC duplicate-suffix 404 to the existing comparison.",
  },
  {
    source: "/cs/sluzby/prevzeti-a-rozvoj-existujici-aplikace-2/",
    target: "/cs/sluzby/prevzeti-a-rozvoj-existujici-aplikace/",
    category: "legacy",
    reason: "Resolve a reported GSC duplicate-suffix 404 to the existing service page.",
  },
  {
    source: "/en/templates/api-integration-checklist-2/",
    target: "/en/templates/api-integration-checklist/",
    category: "legacy",
    reason: "Resolve a reported GSC duplicate-suffix 404 to the existing template.",
  },
  {
    source: "/cs/pripadovky/interni-nastroj-pro-operativu-2/",
    target: "/cs/pripadovky/interni-nastroj-pro-operativu/",
    category: "legacy",
    reason: "Resolve a reported GSC duplicate-suffix 404 to the existing case study.",
  },
  {
    source: "/en/guides/how-to-run-an-app-takeover-audit-2/",
    target: "/en/guides/how-to-run-an-app-takeover-audit/",
    category: "legacy",
    reason: "Resolve a reported GSC duplicate-suffix 404 to the existing guide.",
  },
  {
