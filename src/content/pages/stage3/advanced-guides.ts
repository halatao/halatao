...
export const advancedGuidePages: ContentPage[] = [
  advancedGuide({
    ...
    title: "Jak připravit takeover audit aplikace | Bc. Ondřej Halata",
    breadcrumbLabel: "Jak připravit takeover audit aplikace před převzetím cizího systému",
  ...
  advancedGuide({
    ...
    title: "Potřebuje aplikace rewrite? | Bc. Ondřej Halata",
    breadcrumbLabel: "Jak poznat, že aplikace opravdu potřebuje rewrite a ne jen postupný rozvoj",
    ...
    primaryQuery: "kdy aplikace potřebuje rewrite",
  ...
  advancedGuide({
    ...
    title: "Jak připravit discovery pro automatizaci a integrace | Bc. Ondřej Halata",
    breadcrumbLabel: "Jak připravit discovery pro automatizaci a integrace, aby projekt nezačal chaosem",
  ...
  advancedGuide({
    ...
    title: "Jak nacenit webovou aplikaci | Bc. Ondřej Halata",
    breadcrumbLabel: "Jak nacenit webovou aplikaci bez falešné přesnosti",
  ...
  advancedGuide({
    ...
    title: "Jak naplánovat MVP webové aplikace | Bc. Ondřej Halata",
    breadcrumbLabel: "Jak naplánovat MVP webové aplikace, které není jen polotovar",
    description: "Praktický průvodce, jak navrhnout MVP webové aplikace tak, aby řešilo důležitý problém a nevypadalo jako nedokončený produkt.",
    primaryQuery: "jak naplánovat mvp webové aplikace",
    heroTitle: "MVP není co nejméně funkcí. Je to co nejmenší užitečný celek.",
    heroSubtitle: "První verze musí zvládnout důležitý workflow, ne jen ukázku obrazovek.",
    intro: ["Nejslabší MVP bývá to, které je malé jen na papíře, ale v praxi neřeší celý důležitý scénář. Výsledek pak nikoho nepřesvědčí a jen zvyšuje nedůvěru k projektu.", "Silné MVP je dost úzké na rychlé dodání, ale dost úplné na ověření reálného používání."],
    sections: [
      { title: "Jak vybírat první workflow", body: ["MVP by mělo řešit jeden důležitý proces od začátku do konce, ne deset rozpracovaných polotovarů."], bullets: ["vysoký provozní dopad", "jasný vlastník", "rozumné riziko", "možnost rychlé zpětné vazby"] },
      { title: "Co do MVP nepatří", body: ["Funkce bez jasné návaznosti na hlavní workflow, prémiové doplňky, které nic neověřují, a sekundární scénáře, které jen nafukují scope."] },
      { title: "Jak poznat, že MVP funguje", body: ["Ne podle počtu funkcí, ale podle toho, jestli lidé dokážou s první verzí vyřešit konkrétní problém rychleji a jistěji než předtím."] },
      { title: "Jak připravit další etapy", body: ["Dobré MVP usnadní rozhodnutí, co přidat dál, protože už stojí na reálném používání, ne na hypotézách."] },
    ],
    faq: [
      { question: "Může být MVP interní systém?", answer: "Ano. U interních nástrojů bývá MVP velmi praktický způsob, jak rychle odlehčit hlavnímu bottlenecku." },
  ...
  advancedGuide({
    ...
    title: "Jak stabilizovat pomalou aplikaci | Bc. Ondřej Halata",
    breadcrumbLabel: "Jak stabilizovat pomalou webovou aplikaci pro byznys",
    description: "Praktický průvodce stabilizací pomalé nebo křehké business aplikace bez unáhleného rewritu a bez kosmetických zásahů bez dopadu.",
    primaryQuery: "jak stabilizovat pomalou aplikaci",
    heroTitle: "Pomalá aplikace nebývá jen problém výkonu",
    heroSubtitle: "Často jde i o nejasné priority, křehké dotazy, špatnou práci s daty a release proces, který brzdí opravy.",
    intro: ["Když je aplikace pomalá, tým často sahá po rychlých mikro-optimalizacích. Jenže uživatelé vnímají problém jako celek: výkon, stabilitu i pocit jistoty při používání.", "Praktická stabilizace proto začíná měřením dopadu a prioritizací nejbolestivějších míst."],
    sections: [
      { title: "Kde hledat hlavní příčinu", body: ["Nejde jen o frontend. Problém bývá v dotazech, datech, cachování, infrastruktuře i v tom, jak aplikace roste bez pravidel."], bullets: ["dotazy a práce s databází", "zbytečně těžké obrazovky", "slabé cachování nebo paging", "release proces brzdící opravy"] },
      { title: "Jak postupovat", body: ["Nejdřív změřit a potvrdit dopad. Pak řešit několik nejkritičtějších míst s jasným přínosem, ne plošný refaktor bez směru."] },
      { title: "Co bývá rychlá výhra", body: ["Lepší práce s daty, omezení zbytečných dotazů, úprava nejpomalejších workflow a odstranění největších technických bottlenecků."] },
      { title: "Kdy uvažovat o větší změně", body: ["Až když se ukáže, že problém není v několika uzlech, ale v samotném tvaru architektury nebo datového modelu."] },
    ],
    faq: [
  ...
  advancedGuide({
    ...
    title: "How to estimate a custom web app | Bc. Ondřej Halata",
    breadcrumbLabel: "How to estimate a custom web app without fake precision",
  ...
  advancedGuide({
    ...
    title: "How to plan an MVP web application | Bc. Ondřej Halata",
    breadcrumbLabel: "How to plan an MVP web application that is more than a half-finished product",
  ...
  advancedGuide({
    ...
    title: "How to stabilise a slow business app | Bc. Ondřej Halata",
    breadcrumbLabel: "How to stabilise a slow business application",
  ...
  advancedGuide({
    ...
    title: "How to run an app takeover audit | Bc. Ondřej Halata",
    breadcrumbLabel: "How to run an app takeover audit before inheriting an existing system",
  ...
  advancedGuide({
    ...
    title: "Does the app need a rewrite? | Bc. Ondřej Halata",
    breadcrumbLabel: "How to decide whether an application really needs a rewrite",
  ...
  advancedGuide({
    ...
    title: "How to prepare discovery for automation and integrations | Bc. Ondřej Halata",
    breadcrumbLabel: "How to prepare discovery for automation and integrations without starting in chaos",
