...
export const advancedGuidePages: ContentPage[] = [
  advancedGuide({
    ...
    title: "Jak nacenit webovou aplikaci | Halatao",
  ...
  advancedGuide({
    ...
    title: "Jak naplánovat MVP webové aplikace | Halatao",
  ...
  advancedGuide({
    ...
    title: "Jak stabilizovat pomalou aplikaci | Halatao",
  ...
  advancedGuide({
    ...
    title: "How to estimate a custom web app | Halatao",
  ...
  advancedGuide({
    ...
    title: "How to plan an MVP web application | Halatao",
  ...
  advancedGuide({
    ...
    title: "How to stabilise a slow business app | Halatao",
