...
export const toolPages: ContentPage[] = [
  tool({
    ...
    title: "Brief na webovou aplikaci | Halatao",
  ...
  tool({
    ...
    title: "Checklist převzetí aplikace | Halatao",
  ...
  tool({
    ...
    title: "Checklist API integrace | Halatao",
  ...
  tool({
    ...
    title: "Web app project brief template | Halatao",
  ...
  tool({
    ...
    title: "App takeover checklist | Halatao",
  ...
  tool({
    ...
    title: "API integration checklist | Halatao",
