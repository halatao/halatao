...
export const growthToolPages: ContentPage[] = [
  tool({
    ...
    title: "Scope worksheet pro interní systém | Halatao",
  ...
  tool({
    ...
    title: "Discovery checklist pro automatizace | Halatao",
  ...
  tool({
    ...
    title: "Internal tool scope worksheet | Halatao",
  ...
  tool({
    ...
    title: "Automation discovery checklist | Halatao",
