...
export const problemPages: ContentPage[] = [
  problem({
    ...
    title: "Potřebujeme převzít rozpracovanou aplikaci | Halatao",
    h1: "Potřebujeme převzít rozpracovanou nebo cizí aplikaci",
    description: "Pomohu firmě bezpečně převzít existující aplikaci, zmapovat technická a provozní rizika a navrhnout další postup bez zbytečného chaosu.",
    primaryQuery: "potřebujeme převzít rozpracovanou aplikaci",
    heroTitle: "Aplikace běží, ale nikdo si není jistý dalším krokem",
    heroSubtitle: "Typická situace po změně dodavatele, odchodu vývojáře nebo po delším období bez technického vedení.",
    intro: [
  ...
  problem({
    ...
    title: "Chceme vyvinout interní systém | Halatao",
    h1: "Chceme vyvinout interní systém, který opravdu pomůže provozu",
    description: "Pomohu navrhnout a dodat interní systém na míru tam, kde tabulky, e-maily a poslepované nástroje už nestačí každodennímu provozu.",
    primaryQuery: "chceme vyvinout interní systém",
    heroTitle: "Proces už neudrží Excel ani sdílený inbox",
    heroSubtitle: "Interní systém dává smysl ve chvíli, kdy firma potřebuje lepší dohled, méně ruční koordinace a jasnější odpovědnost mezi rolemi.",
    intro: [
      "Potřeba interního systému obvykle nevzniká proto, že firma chce vlastní software za každou cenu. Vzniká ve chvíli, kdy současná kombinace tabulek, e-mailů a ručních kroků začíná brzdit provoz.",
      "Největší přínos nebývá jen v rychlosti práce, ale v tom, že proces přestane viset na jednotlivcích a vedení začne vidět skutečný stav bez ručně skládaných reportů.",
    ...
    related: ["service-internal-tools-development", "use-case-internal-admin-system", "comparison-custom-vs-saas", "guide-how-to-scope-a-custom-web-application", "inquiry"],
  ...
  problem({
    ...
    title: "Potřebujeme napojit několik systémů | Halatao",
    h1: "Potřebujeme napojit několik systémů a omezit ruční práci",
    description: "Pomohu navrhnout a dodat integrace a automatizace tam, kde firma trpí na přepisování dat, ruční kontroly a nejasný tok informací mezi systémy.",
    primaryQuery: "potřebujeme napojit několik systémů",
    heroTitle: "Data dnes obcházejí lidi místo systému",
    ...
    related: ["service-automations-and-integrations", "use-case-workflow-automation-tools", "case-study-multi-system-integration", "tool-api-integration-checklist", "inquiry"],
  ...
  problem({
    ...
    title: "We need to take over an existing app | Halatao",
  ...
  problem({
    ...
    title: "We need an internal tool | Halatao",
    h1: "We need an internal tool that improves real operations",
    description: "I help teams scope and build internal tools when spreadsheets, inboxes, and fragmented admin tools are no longer enough for daily operations.",
    primaryQuery: "we need an internal tool",
    heroTitle: "The workflow has outgrown spreadsheets and handoffs",
    heroSubtitle: "Internal software becomes the right move when visibility, accountability, and consistency are missing from an important business process.",
    intro: [
  ...
  problem({
    ...
    title: "We need system integrations | Halatao",
