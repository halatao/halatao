...
export const problemPages: ContentPage[] = [
  problem({
    ...
    title: "Potřebujeme převzít rozpracovanou aplikaci | Bc. Ondřej Halata (halatao.cz)",
  ...
  problem({
    ...
    title: "Chceme vyvinout interní systém | Bc. Ondřej Halata (halatao.cz)",
  ...
  problem({
    ...
    title: "Potřebujeme napojit několik systémů | Bc. Ondřej Halata (halatao.cz)",
