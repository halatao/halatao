...
export const problemPages: ContentPage[] = [
  problem({
    ...
    related: ["service-existing-app-takeover", "problem-modernize-legacy-app", "guide-how-to-take-over-an-existing-app-safely", "guide-how-to-run-app-takeover-audit", "guide-how-to-decide-app-needs-rewrite", "tool-release-stabilization-checklist", "inquiry"],
  ...
  problem({
    ...
    heroTitle: "Firma potřebuje jeden vlastní systém pro důležitý proces",
    heroSubtitle: "Interní systém dává smysl ve chvíli, kdy je potřeba sjednotit workflow, role, data a odpovědnost, ne jen nahradit jednu tabulku.",
    intro: [
