...
export const growthProblemPages: ContentPage[] = [
  ...
  problem({
    ...
    symptoms: [
      ...
      "zadavatel nebo tým ztrácí důvěru v původní způsob realizace",
    ],
    ...
    fitNot: ["projekty bez přístupu ke kódu nebo zadání", "zadavatel, který chce jen potvrdit předem daný rewrite", "čistě náborová poptávka bez projektového kontextu"],
  }),
  problem({
  ...
  problem({
    ...
    symptoms: [
      ...
      "stakeholder or team confidence in the current delivery model is low",
    ],
    ...
    fitFor: ["incomplete projects with no believable next milestone", "companies that already invested and need to regain control", "situations requiring both takeover and a new delivery frame"],
    fitNot: ["projects with no access to code or brief", "decision-makers looking only for validation of a pre-decided rewrite", "recruiting-style requests with no project context"],
  }),
  problem({
    translationKey: "problem-client-portal",
    locale: "en",
  ...
  problem({
    ...
    symptoms: [
      "poptávky nejsou na jednom místě a dohledávají se ručně",
      "nabídky existují v různých verzích a bez jasné návaznosti",
    ...
    fitNot: [
      ...
      "organizace, které chtějí jen nový Excel template místo workflow řešení",
    ],
  }),
  problem({
    translationKey: "problem-sales-offers-delivery-chaos",
    ...
    heroSubtitle: "A common situation where the company still functions, but each additional job increases chaos, error risk, and manual coordination pressure.",
    intro: [
