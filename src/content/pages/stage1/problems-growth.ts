...
export const growthProblemPages: ContentPage[] = [
  problem({
    ...
    title: "Nahradit Excel ve firemnim procesu | Bc. Ondrej Halata (halatao.cz)",
    h1: "Potrebujeme nahradit Excel ve firemnim procesu bez dalsiho chaosu",
    description: "Pomohu firmam dostat provozne dulezity proces z Excelu, e-mailu a sdilenych tabulek do rizeneho systemu s jasnym workflow a odpovednosti.",
    primaryQuery: "nahradit excel ve firemnim procesu",
    heroTitle: "Excel byl dobry zacatek, ale dnes uz brzdi dulezity proces",
    heroSubtitle: "Typicka situace, kdy sdilene tabulky, e-maily a rucni dohledavani stavu zvysuji chybovost a berou lidem cas.",
    intro: [
      "Excel nebyva problem sam o sobe. Problem vznika ve chvili, kdy sdilene tabulky nahrazuji system pro stavy, odpovednosti, schvalovani a navaznost na dalsi nastroje.",
      "Silny prvni krok neni navrhovat obecny interni system, ale pojmenovat, kde tabulky a e-mail opravdu brzdi provoz, a navrhnout prvni migracni etapu kolem nejslabsiho mista procesu.",
    ],
    symptoms: [
      "stejna data se prepisuji mezi tabulkami, e-maily a dalsimi nastroji",
      "neni jasne, kdo je za aktualni stav nebo dalsi krok odpovedny",
      "vice lidi pracuje nad ruznymi verzemi teze reality",
      "vyjimky a schvaleni zvysuji zmatek a provozni chyby",
    ],
    whyItMatters: "Kdyz provozne dulezity proces zustane v Excelu prilis dlouho, neroste jen frustrace. Roste i cena koordinace, chybovost a zavislost na lidech, kteri vedi, jak to cele drzet pohromade rucne.",
    approach: "Zacinam mapou tabulek, poli, rucnich kroku, vyjimek a mist, kde se informace dnes rozchazeji. Teprve potom dava smysl navrhnout prvni migracni etapu do systemu, ktery zjednodusi provoz misto digitalni kopie tabulky.",
    outcomes: [
      "mene rucni koordinace a prepisovani dat",
      "jasnejsi odpovednost za stav procesu",
      "lepsi dohledatelnost vyjimek a rozhodnuti",
      "silnejsi zaklad pro dalsi reporting a automatizaci",
    ],
    faq: [
      { question: "Musi se Excel nahradit cely najednou?", answer: "Nemusi. Casto je lepsi vybrat jednu provozne kritickou cast procesu a na ni postavit prvni verzi interniho systemu." },
      { question: "Neni levnejsi zustat u tabulek a jen zlepsit disciplinu?", answer: "Nekdy kratkodobe ano. Pokud ale proces obsahuje role, vyjimky a navaznosti, lepsi disciplina obvykle neodstrani samotnou provozni slozitost." },
      { question: "Je to vhodne i pro mensi firmu?", answer: "Ano, pokud proces realne brzdi lidi, vytvari chyby nebo zavislost na rucni koordinaci mezi nekolika rolemi." },
    ],
    ...
    fitFor: ["firmy, ktere ridi dulezity proces v tabulkach a e-mailech", "tymy s vice rolemi, stavy a vyjimkami", "situace, kde je potreba nahradit rucni koordinaci vlastnim systemem"],
    fitNot: ["jednoducha jednorazova evidence bez workflow", "proces bez ownera nebo bez rozhodovatele", "snahy digitalizovat chaos bez ochoty popsat skutecny provoz"],
  }),
  problem({
    translationKey: "problem-modernize-legacy-app",
    locale: "cs",
    slug: "potrebujeme-modernizovat-legacy-aplikaci",
    title: "Modernizace legacy aplikace | Bc. Ondrej Halata (halatao.cz)",
    h1: "Potrebujeme modernizovat legacy aplikaci bez rozbiti provozu",
    description: "Pomohu firmam modernizovat legacy aplikaci postupne a bezpecne, kdyz je system stale provozne dulezity, ale dalsi zmeny jsou prilis drahe, pomale nebo riskantni.",
    primaryQuery: "modernizace legacy aplikace",
    heroTitle: "Bezici legacy aplikace potrebuje plan modernizace, ne dalsi improvizaci",
    heroSubtitle: "Typicka situace, kdy aplikaci uz tym zna a provozuje ji, ale dalsi rozvoj je pomaly, nejisty a zbytecne drahy.",
    intro: [
    ...
    whyItMatters: "Pokud legacy system zustane bez planu modernizace, firma plati vyssi cenu za kazdou dalsi zmenu, roste provozni riziko a tlak na velke rozhodnuti bez dostatecneho podkladu.",
    approach: "Zacinam mapovanim kritickych zavislosti, provoznich rizik, release slabin a mist, kde dava modernizace nejvetsi pomer dopadu k riziku. Teprve pak dava smysl rozhodovat mezi postupnou modernizaci a vetsim prepisem.",
    outcomes: [
    ...
    faq: [
      { question: "Je legacy aplikace automaticky kandidat na rewrite?", answer: "Ne. Dulezite je, jake konkretni provozni a delivery problemy zpusobuje, ne jen jeji stari nebo technologie." },
      { question: "Lze modernizovat jen nejkritictejsi casti?", answer: "Ano. U mnoha bezicich aplikaci je to bezpecnejsi a ekonomicky rozumnejsi nez velky restart." },
      { question: "Je to jen jiny nazev pro takeover aplikace?", answer: "Ne. Tato stranka miri hlavne na situace, kdy tym uz aplikaci provozuje nebo ji ma pod kontrolou, ale potrebuje rozumny plan modernizace bez velkeho restartu." },
    ],
    ...
    fitFor: ["firmy s bezici legacy aplikaci, ktera porad drzi provoz", "tymy, ktere chteji modernizovat bez ztraty kontroly", "situace, kde je treba spojit takeover, stabilizaci a dalsi rozvoj"],
    fitNot: ["projekty s predem narizenym rewrite bez analyzy", "aplikace bez pristupu ke kodu nebo prostredi", "ciste kosmeticke redesigny bez provozniho dopadu"],
  }),
  problem({
  ...
  problem({
    ...
    title: "Potřebujeme zachránit rozdělaný projekt | Bc. Ondřej Halata (halatao.cz)",
  ...
  problem({
    ...
    title: "Potřebujeme klientský portál | Bc. Ondřej Halata (halatao.cz)",
