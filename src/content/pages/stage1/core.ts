...
export const corePages: ContentPage[] = [
  home("cs", {
    title: "Webové aplikace na míru, takeover a interní systémy | Bc. Ondřej Halata",
    h1: "Webové aplikace na míru, takeover a interní systémy pro firmy",
    description: "Webové aplikace na míru, převzetí existujících aplikací, interní systémy a automatizace pro firmy, které potřebují dodat nebo stabilizovat důležitý software.",
    heroTitle: "Webové aplikace na míru, takeover a interní systémy pro firmy",
    heroSubtitle: "Pomohu navrhnout novou aplikaci, bezpečně převzít existující systém nebo nahradit ruční provoz interním nástrojem, který jde dál rozvíjet.",
    intro: [
      "Pomohu firmám, které řeší webovou aplikaci na míru, převzetí existujícího systému, interní nástroj pro operativu nebo automatizace mezi více systémy.",
      "Nejdůležitější není jen napsat funkční kód. Klíčové je správně nastavit první etapu, snížit provozní riziko a rozhodnout, co má největší obchodní dopad právě teď.",
      "Část projektů stavím od nuly, část přebírám po předchozím dodavateli nebo interním týmu. V obou situacích řeším architekturu, provozní realitu, bezpečnost změn i to, aby šel software dlouhodobě rozvíjet bez zbytečného chaosu.",
      "Největší smysl má spolupráce tam, kde aplikace nebo interní systém řeší důležitý firemní proces a potřebuje seniorní technické vedení místo čistě kapacitního vývoje.",
