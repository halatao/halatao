...
export const servicePages: ContentPage[] = [
  ...
  service({
    ...
    deliveryLead: "Řešení typicky sjednotí obchodní i realizační část procesu do jednoho přehledu a doplní workflow, historii a odpovědnost.",
    delivery: [
    ...
    processLead: "Nejdřív je potřeba popsat, jak proces funguje dnes, kde se ztrácí informace a kde má systém přinést největší úlevu. Teprve potom dává smysl navrhnout první verzi řešení.",
  ...
  service({
    ...
    h1: "System for managing incoming requests, offers, and delivery",
