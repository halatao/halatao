...
export const servicePages: ContentPage[] = [
  ...
  service({
    ...
    deliveryLead: "Součástí dodávky je návrh i vývoj řešení: sjednocení obchodní a realizační části procesu, jasné role a stavy, historie změn a potřebné integrace.",
    delivery: [
    ...
    processLead: "Spolupráce začíná zmapováním současného procesu, rolí, dat a slabých míst. Potom navrhnu první smysluplnou etapu, dodám ji v menších krocích a rozsah dalších fází upravíme podle reálného provozu.",
    ...
    priorityLinks: [
      ...
      { label: "Kdy Excel a e-mail přestávají na tento proces stačit", href: "/cs/problemy/poptavky-nabidky-a-realizace-v-excelu-a-emailu/" },
