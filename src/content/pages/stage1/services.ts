...
export const servicePages: ContentPage[] = [
  ...
  service({
    ...
    situationsLead: "Nejčastěji jde o firmy, kde nad jednou zakázkou pracuje obchod, příprava nabídky a následná realizace, ale každý krok se dnes eviduje jinde.",
    situations: [
    ...
    deliveryLead: "Systém typicky spojí obchodní a realizační část procesu do jednoho přehledu a doplní workflow, historii a odpovědnost.",
    delivery: [
      "evidence poptávek a jejich stavů",
    ...
    processLead: "Nejdřív je potřeba popsat současný proces, slabá místa a místa, kde se ztrácí informace. Teprve potom dává smysl navrhnout první verzi systému.",
    resultsLead: "Dobrý výsledek není jen nový nástroj. Dobrý výsledek je menší chaos, lepší přehled a jasnější odpovědnost mezi obchodem a realizací.",
    results: [
      "lepší přehled nad stavem poptávek a zakázek",
    ...
    faq: [
      { question: "Je to vhodné i pro menší firmu?", answer: "Ano, pokud se proces opakuje dost často a současný způsob evidence už začíná být nepřehledný nebo chybový." },
      { question: "Musí systém pokrýt celý proces od začátku?", answer: "Nemusí. Často dává smysl začít jednou etapou a teprve potom systém rozšiřovat." },
      { question: "Lze ho napojit na další systémy?", answer: "Ano. Typicky na e-mail, CRM, fakturaci nebo další interní nástroje, aby nezůstával izolovaný." },
    ],
    related: [
      "service-internal-tools-development",
      "service-automations-and-integrations",
  ...
  service({
    translationKey: "service-request-offer-delivery-system",
    locale: "en",
    slug: "request-offer-delivery-system",
    title: "A simple system for managing requests, offers and jobs",
    h1: "A simple system for managing requests, offers and jobs",
    description: "I design and build a simple internal system for teams that need to manage requests, offers, and delivery jobs in one place instead of relying on spreadsheets, email, and manual coordination.",
    primaryQuery: "request offer delivery system",
    heroTitle: "One place for requests, offers, and delivery jobs",
    heroSubtitle: "No more spreadsheet sprawl, lost emails, or unclear job status. A system built around how your team actually works.",
    intro: [
    ...
    deliveryLead: "The system usually connects sales and delivery into one workflow with shared visibility, history, and responsibility.",
    delivery: [
      "tracking of incoming requests and their statuses",
    ...
    processLead: "The first step is to understand how the current process works, where information gets lost, and where the system should create the biggest relief.",
    resultsLead: "The best outcome is not just a new tool. It is less coordination overhead, fewer mistakes, and a clearer shared view of every job.",
    results: [
    ...
    faq: [
      { question: "Is this useful for a small team too?", answer: "Yes, especially when requests and jobs already repeat often enough that the current setup slows people down or creates avoidable confusion." },
      { question: "Does the system need to cover the full process from day one?", answer: "No. It is often better to start with one stage and expand later." },
      { question: "Can it connect to other systems?", answer: "Yes. Typical integrations include email, CRM, invoicing, or other internal tools so the system does not stay isolated." },
    ],
    related: [
      "service-internal-tools-development",
