...
export const servicePages: ContentPage[] = [
  service({
    ...
    related: ["comparison-custom-vs-saas", "guide-how-to-scope-a-custom-web-application", "use-case-b2b-client-portal", "problem-client-portal", "inquiry"],
  ...
  service({
    ...
    related: ["problem-app-takeover", "guide-how-to-take-over-an-existing-app-safely", "guide-how-to-price-an-app-takeover", "problem-rescue-incomplete-project", "inquiry"],
  ...
  service({
    ...
    related: ["comparison-custom-vs-saas", "guide-how-to-scope-a-custom-web-application", "use-case-internal-admin-system", "problem-internal-tool", "inquiry"],
  ...
  service({
    ...
    related: ["problem-system-integrations", "use-case-workflow-app-for-teams", "tool-api-integration-checklist", "tool-automation-discovery-checklist", "inquiry"],
