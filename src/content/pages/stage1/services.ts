...
export const servicePages: ContentPage[] = [
  service({
    ...
    title: "Vývoj webových aplikací na míru pro firmy | Bc. Ondřej Halata (halatao.cz)",
    h1: "Vývoj webových aplikací na míru pro firmy a týmy",
    description: "Navrhuji a vyvíjím webové aplikace na míru pro firmy, které potřebují vlastní workflow, role, integrace a dlouhodobě udržitelný provoz.",
    ...
    intro: [
      "Vývoj na míru je vhodný ve chvíli, kdy byznys potřebuje vlastní logiku, více rolí, schvalování nebo napojení na další systémy a hotový SaaS nástroj vytváří víc kompromisů než užitku.",
      "Nejde jen o napsání funkcí. Důležitý je návrh dat, hranic systému, oprávnění, provozu a toho, aby šla aplikace rozumně rozvíjet i za rok nebo dva bez drahých obcházek.",
    ...
    related: ["comparison-custom-vs-saas", "guide-how-to-scope-a-custom-web-application", "use-case-b2b-client-portal", "use-case-b2b-partner-portal", "problem-client-portal", "inquiry"],
  ...
  service({
    ...
    title: "Převzetí existující aplikace bez zbytečného rizika | Bc. Ondřej Halata (halatao.cz)",
    h1: "Převzetí a rozvoj existující aplikace bez zbytečného rizika",
    description: "Pomohu bezpečně převzít existující nebo rozpracovanou aplikaci, zmapovat rizika, stabilizovat kritická místa a navrhnout další rozvoj bez unáhleného rewritu.",
    ...
    intro: [
      ...
      "Největší problém nebývá jen v kódu, ale v nejistotě, co si lze dovolit změnit, kde už hrozí dopad do provozu a jak rychle vrátit projektu důvěryhodný další krok.",
    ...
    related: ["problem-app-takeover", "problem-modernize-legacy-app", "guide-how-to-take-over-an-existing-app-safely", "guide-how-to-run-app-takeover-audit", "guide-how-to-decide-app-needs-rewrite", "tool-release-stabilization-checklist", "inquiry"],
  ...
  service({
    ...
    title: "Interní systémy na míru pro firmy | Bc. Ondřej Halata (halatao.cz)",
    ...
    related: ["comparison-custom-vs-saas", "comparison-internal-tool-vs-spreadsheets", "problem-replace-spreadsheets-in-process", "use-case-internal-admin-system", "use-case-service-team-ops-system", "tool-excel-to-internal-tool-migration-checklist", "inquiry"],
  ...
  service({
    ...
    title: "Automatizace a integrace systémů pro firmy | Bc. Ondřej Halata (halatao.cz)",
    h1: "Automatizace a integrace systémů pro firmy",
    description: "Pomohu zjistit, kde ve firmě vzniká zbytečná ruční práce a kde dávají automatizace a integrace systémů skutečný provozní smysl.",
    primaryQuery: "automatizace a integrace systémů",
    heroTitle: "Automatizace a integrace systémů bez další provozní vrstvy chaosu",
    heroSubtitle: "Pro firmy, kde se data přepisují mezi systémy, ručně se kontrolují stavy a důležité workflow zbytečně stojí na manuální koordinaci.",
    intro: [
    ...
    related: ["problem-system-integrations", "guide-how-to-run-automation-discovery", "use-case-workflow-app-for-teams", "use-case-service-team-ops-system", "tool-api-integration-checklist", "tool-automation-discovery-checklist", "inquiry"],
