...
export const servicePages: ContentPage[] = [
  service({
    ...
    title: "Vývoj webových aplikací na míru | Bc. Ondřej Halata (halatao.cz)",
  ...
  service({
    ...
    title: "Převzetí a rozvoj existující aplikace | Bc. Ondřej Halata (halatao.cz)",
  ...
  service({
    ...
    title: "Interní systémy na míru | Bc. Ondřej Halata (halatao.cz)",
