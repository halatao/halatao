...
export const referencePages: ContentPage[] = [
  definePage({
    ...
    slug: "reference",
    segments: ["reference"],
    title: "Reference webů, aplikací a interních systémů | Ondřej Halata",
    breadcrumbLabel: "Reference webů a aplikací",
    description: "Vybrané firemní weby, webové aplikace, CRM, marketplace a obsahové platformy, na kterých jsem řešil návrh, vývoj, nasazení nebo další provoz.",
    primaryQuery: "reference weby aplikace",
    intent: "commercial",
    hero: {
      eyebrow: "Vybrané realizace",
      title: "Weby a aplikace, které jsem navrhl, vytvořil a uvedl do provozu.",
  ...
  definePage({
    ...
    description: "Selected company websites, custom web applications, CRM, marketplace, and publishing platforms that I designed, developed, deployed, or continue to operate.",
    primaryQuery: "website application developer portfolio",
    intent: "commercial",
    hero: {
      eyebrow: "Selected work",
      title: "Websites and applications I designed, built, and brought into operation.",
