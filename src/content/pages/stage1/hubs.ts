...
export const stage1HubPages: ContentPage[] = [
  hub({
    ...
    slug: "sluzby",
    segment: "sluzby",
    title: "Služby pro webové aplikace, takeover a interní systémy | Halatao",
  ...
  hub({
    ...
    slug: "services",
    segment: "services",
    title: "Services for custom apps, takeover, internal tools, and contract support | Halatao",
  ...
  hub({
    ...
    slug: "problemy",
    segment: "problemy",
    title: "Projektové problémy: takeover, interní systém, integrace a rescue | Halatao",
  ...
  hub({
    ...
    slug: "problems",
    segment: "problems",
    title: "Project problems: inherited apps, internal tools, integrations, and rescue work | Halatao",
