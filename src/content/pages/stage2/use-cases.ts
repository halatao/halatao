...
export const useCasePages: ContentPage[] = [
  useCase({
    ...
    title: "Klientský portál na míru | Halatao",
    h1: "Klientský portál na míru pro komunikaci, data a samoobsluhu",
    description: "Příklad klientského portálu na míru pro firmy, které chtějí zpřehlednit komunikaci se zákazníky, dokumenty, stav zakázek nebo samoobslužné úkony.",
    primaryQuery: "klientský portál na míru",
    heroTitle: "Klientský portál místo roztříštěné komunikace",
    heroSubtitle: "Pro firmy, které chtějí zákazníkům nebo partnerům nabídnout jedno místo pro informace, dokumenty, stavy a další kroky.",
    intro: ["Klientský portál dává smysl tam, kde se opakuje komunikace kolem stavu služby, dokumentů, objednávek nebo požadavků.", "Místo e-mailových vláken a ručního posílání informací může mít klient jedno přehledné rozhraní s historií, přístupy a návaznými kroky."],
  ...
  useCase({
    ...
    title: "Interní admin systém na míru | Halatao",
  ...
  useCase({
    ...
    title: "Reporting dashboard na míru | Halatao",
  ...
  useCase({
    ...
    title: "Workflow automatizace ve firmě | Halatao",
  ...
  useCase({
    ...
    title: "Client portal development | Halatao",
    h1: "Client portal development for communication, visibility, and self-service",
    description: "A client portal use case for companies that want one place for customer communication, documents, status tracking, and self-service actions.",
    primaryQuery: "client portal development",
    heroTitle: "A client portal instead of fragmented communication",
    heroSubtitle: "Useful when customers or partners need a clearer place for status, documents, messages, and next steps.",
    intro: [
  ...
  useCase({
    ...
    title: "Internal admin system development | Halatao",
  ...
  useCase({
    ...
    title: "Reporting dashboard development | Halatao",
  ...
  useCase({
    ...
    title: "Workflow automation tools | Halatao",
