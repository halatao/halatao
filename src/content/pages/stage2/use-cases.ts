...
export const useCasePages: ContentPage[] = [
  ...
  defineUseCasePage({
    ...
    title: "Automatizace předávání úkolů a schvalování | Ondřej Halata",
    breadcrumbLabel: "Automatizace předávání úkolů a schvalování",
    description: "Příklad automatizace předávání úkolů, schvalování, notifikací a návazných kroků mezi systémy bez zbytečné ruční koordinace.",
    primaryQuery: "automatizace předávání úkolů a schvalování",
