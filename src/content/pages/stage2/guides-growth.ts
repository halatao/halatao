...
export const growthGuidePages: ContentPage[] = [
  guide({
    ...
    title: "Jak nacenit převzetí aplikace | Halatao",
  ...
  guide({
    ...
    title: "Kdy dává smysl interní systém místo SaaS | Halatao",
  ...
  guide({
    ...
    title: "Jak poznat, že projekt potřebuje externí seniorní kapacitu | Halatao",
  ...
  guide({
    ...
    title: "How to price an app takeover | Halatao",
  ...
  guide({
    ...
    title: "When an internal tool is better than SaaS | Halatao",
  ...
  guide({
    ...
    title: "How to know when a project needs senior contract support | Halatao",
