...
export const comparisonPages: ContentPage[] = [
  comparison({
    ...
    title: "Interní systém vs Excel a e-mail | Bc. Ondřej Halata",
    breadcrumbLabel: "Interní systém vs Excel a e-mail: kdy začíná dávat smysl vlastní nástroj",
    description: "Praktické srovnání interního systému s kombinací Excelu a e-mailu pro firmy, které řeší workflow, schvalování a sdílenou operativu.",
    primaryQuery: "interni system vs excel a email",
    heroTitle: "Nejde o to, jestli tabulka stačí dnes. Jde o to, co bude stát zítra.",
    heroSubtitle: "Excel a e-mail jsou často dobrý začátek. Ve složitějším provozu ale začnou zdražovat koordinaci, zvyšovat chybovost a brzdit další růst.",
    intro: [
      "Tabulka sama o sobě není špatně. Problém začíná ve chvíli, kdy má proces více rolí, stavů, výjimek a návazností a koordinace se rozpadá mezi e-mail, chat a ruční dohledávání.",
      "Krátká odpověď je jednoduchá: pokud proces už nezvládáte udržet přehledně a spolehlivě v tabulkách, dává interní systém smysl dřív, než chaos dál zdraží provoz.",
    ],
    optionA: "Kdy je Excel a e-mail ještě v pořádku",
    optionB: "Kdy je lepší interní systém",
    optionAText: "Excel a e-mail mohou stačit tam, kde je proces jednoduchý, málo frekventovaný, s malým počtem rolí a bez citlivých schvalovacích nebo auditních nároků.",
    optionBText: "Interní systém dává smysl tam, kde proces potřebuje jasné role, workflow, dohledatelnost, napojení na další systémy nebo rychlejší a bezpečnější průchod mezi kroky.",
    criteria: ["počet rolí a střídání odpovědnosti", "míra výjimek a schvalování", "dopad chyb a zpoždění na provoz", "potřeba datové historie, reportingu a integrací"],
    verdict: "Pokud tabulky a e-maily už nevytvářejí přehled, ale spíše zmatek, interní systém bývá levnější než další roky ruční koordinace. Pokud je proces opravdu jednoduchý, tabulka může stále dávat smysl.",
    faq: [
      { question: "Není vlastní interní systém zbytečně drahý?", answer: "Někdy by byl. Pokud ale ruční koordinace, chybovost a závislost na lidech už firmu reálně stojí čas a peníze, může být vlastní systém dlouhodobě levnější." },
      { question: "Dá se začít menší první verzí?", answer: "Ano. U interních systémů je to často nejlepší cesta, jak nahradit nejslabší část procesu bez zbytečného přescopování." },
      { question: "Co když firma nechce opustit Excel úplně?", answer: "To je v pořádku. Někdy dává smysl ponechat tabulky pro vedlejší evidenci a přenést do systému jen klíčový workflow." },
      { question: "Jak poznat, že je čas přestat to držet ručně?", answer: "Ve chvíli, kdy není jasné, kde se proces zasekl, kdo má další krok, která data jsou správně a chyba už má provozní nebo finanční dopad." },
    ],
  ...
  comparison({
    ...
    title: "Vývoj na míru vs SaaS | Bc. Ondřej Halata",
    breadcrumbLabel: "Vývoj na míru vs SaaS: kdy dává co větší smysl",
  ...
  comparison({
    ...
    title: "Externí vývojář vs agentura | Bc. Ondřej Halata",
    breadcrumbLabel: "Externí vývojář vs agentura: co je pro projekt vhodnější",
  ...
  comparison({
    ...
    title: "Next.js vs SPA pro byznys aplikace | Bc. Ondřej Halata",
    breadcrumbLabel: "Next.js vs SPA pro byznys aplikace",
  ...
  comparison({
    ...
    title: "Rewrite vs postupný rozvoj aplikace | Bc. Ondřej Halata",
    breadcrumbLabel: "Rewrite vs postupný rozvoj aplikace",
  ...
  comparison({
    ...
    title: "Custom web app vs SaaS tool | Bc. Ondřej Halata",
    breadcrumbLabel: "Custom web app vs SaaS tool: which makes more sense",
  ...
  comparison({
    ...
    title: "Contract developer vs agency | Bc. Ondřej Halata",
    breadcrumbLabel: "Contract developer vs agency: which model fits the project",
  ...
  comparison({
    ...
    title: "Next.js vs SPA for business apps | Bc. Ondřej Halata",
    breadcrumbLabel: "Next.js vs SPA for business applications",
  ...
  comparison({
    ...
    title: "Rewrite vs incremental app improvement | Bc. Ondřej Halata",
    breadcrumbLabel: "Rewrite vs incremental app improvement",
  ...
  comparison({
    ...
    title: "Internal tool vs spreadsheets and email | Bc. Ondřej Halata",
    breadcrumbLabel: "Internal tool vs spreadsheets and email: when custom operations software starts making sense",
