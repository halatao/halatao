...
export const guidePages: ContentPage[] = [
  guide({
    ...
    title: "Jak zadat vývoj webové aplikace | Halatao",
  ...
  guide({
    ...
    title: "Jak převzít existující aplikaci bez rizika | Halatao",
  ...
  guide({
    ...
    title: "Kdy dává smysl vývoj na míru | Halatao",
  ...
  guide({
    ...
    title: "How to scope a custom web application | Halatao",
  ...
  guide({
    ...
    title: "How to take over an existing app safely | Halatao",
  ...
  guide({
    ...
    title: "When custom development makes sense | Halatao",
