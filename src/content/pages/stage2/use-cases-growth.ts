...
export const growthUseCasePages: ContentPage[] = [
  ...
  defineGrowthUseCasePage({
    ...
    title: "AI nad interními dokumenty a znalostmi firmy | Bc. Ondřej Halata (halatao.cz)",
  ...
  defineGrowthUseCasePage({
    ...
    title: "AI over internal documents and company knowledge | Bc. Ondřej Halata (halatao.cz)",
  ...
  defineGrowthUseCasePage({
    ...
    title: "AI zpracování příchozí agendy a požadavků | Bc. Ondřej Halata (halatao.cz)",
  ...
  defineGrowthUseCasePage({
    ...
    title: "AI intake processing and request triage | Bc. Ondřej Halata (halatao.cz)",
