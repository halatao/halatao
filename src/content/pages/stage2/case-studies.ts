...
export const caseStudyPages: ContentPage[] = [
  caseStudy({
    ...
    title: "Převzetí existující aplikace | Halatao",
  ...
  caseStudy({
    ...
    title: "Interní nástroj pro operativu | Halatao",
  ...
  caseStudy({
    ...
    title: "Integrace několika systémů | Halatao",
  ...
  caseStudy({
    ...
    title: "Existing app takeover case study | Halatao",
  ...
  caseStudy({
    ...
    title: "Internal tool for operations case study | Halatao",
  ...
  caseStudy({
    ...
    title: "Multi-system integration case study | Halatao",
